...
if (!class_exists('OP_AC_Webhook')) {
    class OP_AC_Webhook extends OP_ActiveCampaign
    {
        ...
        {
            // process an incoming webhook payload (from OP_ActiveCampaign), and format it (or do something with it)
