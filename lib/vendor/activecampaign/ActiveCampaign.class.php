...
if (!class_exists('OP_ActiveCampaign')){
    class OP_ActiveCampaign extends OP_AC_Connector {
        ...
        function __construct($url, $api_key, $api_user = "", $api_pass = "", $logger) {
        ...
        function api($path, $post_data = array()) {
            ...
            $add_tracking = false;
            if ($class == "OP_AC_Tracking") $add_tracking = true;
