...
class OP_MailChimp
{
    ...
    */
     ...
     * @throws \Exception
     */
    public function __construct($api_key, \OptimizePress_Modules_Email_LoggerInterface $logger)
    {
    ...
    private function makeRequest($http_verb, $method, $args = array(), $timeout = 10)
    {
        ...
        if ($response['body'] === false) {
            ...
            $this->logger->debug('Error: ' . print_r($this->last_error, true));
        }
        ...
        $this->logger->debug('Response: ' . print_r($formattedResponse, true));
