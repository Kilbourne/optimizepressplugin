 ...
 *  - OP_AWeberEntry - a single instance of an AWeber resource
 *  - OP_AWeberCollection - a collection of AWeber resources
 * @uses OP_AWeberAPIBase
 * @package 
 * @version $id$
 */
class OP_AWeberResponse extends OP_AWeberAPIBase {
     ...
     * __construct
     *
     * Creates a new OP_AWeberRespones
     *
