...
class OP_AWeberException extends Exception { }

/**
 * Thrown when the API returns an error. (HTTP status >= 400)
 *
 *
 * @uses OP_AWeberException
 * @package
 * @version $id$
 */
class OP_AWeberAPIException extends OP_AWeberException {
 ...
 * @version $id$
 */
class OP_AWeberResourceNotImplemented extends OP_AWeberException {
 ...
 * @version $id$
 */
class OP_AWeberMethodNotImplemented extends OP_AWeberException {
 ...
 * @version $id$
 */
class OP_AWeberOAuthException extends OP_AWeberException {
 ...
 * @version $id$
 */
class OP_AWeberOAuthDataMissing extends OP_AWeberException {
 ...
 * @version $id$
 */
class OP_AWeberResponseError extends OP_AWeberException {
