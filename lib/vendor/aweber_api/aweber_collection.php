<?php
class OP_AWeberCollection extends OP_AWeberResponse implements ArrayAccess, Iterator, Countable {
    ...
    public function offsetGet($offset) {
        ...
        return new OP_AWeberEntry($entry, $entry_url, $this->adapter);
    }
